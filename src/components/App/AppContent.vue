    ...
    <main>
      <div class="relative isolate">
        ...
        <div class="overflow-hidden">
          <div class="mx-auto max-w-7xl px-6 pb-22 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <div class="bg-opacity-20 backdrop-blur-lg">
              ...
              <p class="backdrop-blur-md bg-white/50 mt-6 text-lg leading-8 text-gray-600">Esse id magna consectetur fugiat non dolor in ad laboris magna laborum ea consequat. Nisi irure aliquip nisi adipisicing veniam voluptate id. In veniam incididunt ex veniam adipisicing sit.</p>
            </div>
            <div class="mt-10 flex items-center gap-x-6">
              <BaseButton /> 
